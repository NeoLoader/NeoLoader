...
public:
	...
	const KeyHashMap& GetKeywordMap() {return m_Keyword_map;}
	const SrcHashMap& GetSourcesMap() {return m_Sources_map;}
	const SrcHashMap& GetNotesMap() {return m_Notes_map;}
	const LoadMap& GetLoadMap() {return m_Load_map;}
	uint32_t GetIndexSource() {return m_totalIndexSource;}
	uint32_t GetIndexKeyword() {return m_totalIndexKeyword;}
	uint32_t GetIndexNotes() {return m_totalIndexNotes;}
	uint32_t GetIndexLoad() {return m_totalIndexLoad;}
