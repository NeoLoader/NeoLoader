...
public:
	...
	static CPrefs *			GetPrefs() throw()				{ if(!instance || !instance->m_prefs) return NULL; else return instance->m_prefs; }
	static CRoutingZone *		GetRoutingZone()			{ if(!instance || !instance->m_routingZone){ ASSERT(0); return NULL;} return instance->m_routingZone; }
	static CKademliaUDPListener *	GetUDPListener()		{ if(!instance || !instance->m_udpListener){ ASSERT(0); return NULL;} return instance->m_udpListener; }
	static CIndexed *		GetIndexed()					{ if(!instance || !instance->m_indexed){ ASSERT(0); return NULL;} return instance->m_indexed; }
...
private:
	...
	static time_t	m_lastFirewallCheck;
...
wstring KadGetKeywordBytes(const wstring& rstrKeywordW);
