...
public:
	...
	static void StaticAlgorithmName(char* Name) {strcat(Name, "EME-PKCS1-v1_5");}
...
CRYPTOPP_DLL_TEMPLATE_CLASS PKCS_DigestDecoration<Tiger>;
CRYPTOPP_DLL_TEMPLATE_CLASS PKCS_DigestDecoration<RIPEMD160>;
#endif
...
public:
	...
	static void StaticAlgorithmName(char* Name) {strcat(Name, "EMSA-PKCS1-v1_5");}
