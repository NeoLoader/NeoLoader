...
{
	//CRYPTOPP_DLL static const char *StaticAlgorithmName() {return "Serpent";}
	CRYPTOPP_DLL static void StaticAlgorithmName(char* Name) {strcat(Name, "Serpent");}
};

/// <a href="http://www.weidai.com/scan-mirror/cs.html#Serpent">Serpent</a>
class CRYPTOPP_DLL Serpent : public Serpent_Info, public BlockCipherDocumentation
{
	class CRYPTOPP_DLL CRYPTOPP_NO_VTABLE Base : public BlockCipherImpl<Serpent_Info>
	{
	public:
