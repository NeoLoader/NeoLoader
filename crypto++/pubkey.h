...
public:
	...
	static void CRYPTOPP_API StaticAlgorithmName(char* Name) {strcat(Name, "MGF1");}
...
public:
	...
	static void CRYPTOPP_API StaticAlgorithmName(char* Name) {strcat(Name, COFACTOR_OPTION::ToEnum() == INCOMPATIBLE_COFACTOR_MULTIPLICTION ? "DHC" : "DH");}
...
public:
	...
	static void CRYPTOPP_API StaticAlgorithmName(char* Name) {KEYS::StaticAlgorithmName(Name); strcat(Name, "/"); MessageEncodingMethod::StaticAlgorithmName(Name);}
...
public:
	...
	static void CRYPTOPP_API StaticAlgorithmName(char* Name) {KEYS::StaticAlgorithmName(Name); strcat(Name, "/"); MessageEncodingMethod::StaticAlgorithmName(Name); strcat(Name, "("); H::StaticAlgorithmName(Name); strcat(Name, ")"); }
...
public:
	...
	static void StaticAlgorithmName(char* Name) {SA::StaticAlgorithmName(Name); strcat(Name, "/EMSA1("); H::StaticAlgorithmName(Name); strcat(Name, ")"); }
