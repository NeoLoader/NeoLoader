...
public:
	...
	static void CRYPTOPP_API StaticAlgorithmName(char* Name) {strcat(Name,"OAEP-"); MGF::StaticAlgorithmName(Name); strcat(Name,"("); H::StaticAlgorithmName(Name); strcat(Name,")");}
