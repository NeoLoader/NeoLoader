...
struct DES_Info : public FixedBlockSize<8>, public FixedKeyLength<8>
{
	...
	//static void StaticAlgorithmName(char* Name) {strcat(Name, "DES");}
	static void StaticAlgorithmName(char* Name) {strcat(Name, "DES");}
};
...
struct DES_EDE2_Info : public FixedBlockSize<8>, public FixedKeyLength<16>
{
	...
	CRYPTOPP_DLL static void CRYPTOPP_API StaticAlgorithmName(char* Name) {strcat(Name, "DES-EDE2");}
};
...
struct DES_EDE3_Info : public FixedBlockSize<8>, public FixedKeyLength<24>
{
	...
	CRYPTOPP_DLL static void CRYPTOPP_API StaticAlgorithmName(char* Name) {strcat(Name, "DES-EDE3");}
};
...
struct DES_XEX3_Info : public FixedBlockSize<8>, public FixedKeyLength<24>
{
	...
	static void StaticAlgorithmName(char* Name) {strcat(Name, "DES-XEX3");}
};
