...
{
	//static const char CRYPTOPP_DLL *StaticAlgorithmName() {return "Salsa20";}
	static void CRYPTOPP_API StaticAlgorithmName(char* Name) {strcat(Name, "Salsa20");}
};

class CRYPTOPP_DLL CRYPTOPP_NO_VTABLE Salsa20_Policy : public AdditiveCipherConcretePolicy<word32, 16>
{
protected:
...
{
	//static const char CRYPTOPP_DLL *StaticAlgorithmName() {return "XSalsa20";}
	static void CRYPTOPP_API StaticAlgorithmName(char* Name) {strcat(Name, "XSalsa20");}
};

class CRYPTOPP_DLL CRYPTOPP_NO_VTABLE XSalsa20_Policy : public Salsa20_Policy
{
public:
	void CipherSetKey(const NameValuePairs &params, const byte *key, size_t length);
	void CipherResynchronize(byte *keystreamBuffer, const byte *IV, size_t length);
