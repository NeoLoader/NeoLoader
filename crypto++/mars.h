...
{
	//CRYPTOPP_DLL static const char *StaticAlgorithmName() {return "MARS";}
	CRYPTOPP_DLL static void StaticAlgorithmName(char* Name) {strcat(Name, "MARS");}
};

/// <a href="http://www.weidai.com/scan-mirror/cs.html#MARS">MARS</a>
class CRYPTOPP_DLL MARS : public MARS_Info, public BlockCipherDocumentation
{
	class CRYPTOPP_DLL CRYPTOPP_NO_VTABLE Base : public BlockCipherImpl<MARS_Info>
	{
	public:
