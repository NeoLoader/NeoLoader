...
public:
	...
	static void CRYPTOPP_API StaticAlgorithmName(char* Name) {ALGORITHM_INFO::StaticAlgorithmName(Name);}
	void AlgorithmName(char* Name) const {ALGORITHM_INFO::StaticAlgorithmName(Name);}
};
...
public:
	...
	void AlgorithmName(char* Name) const {strcat(Name, "BitBucket");}
	void IsolatedInitialize(const NameValuePairs &parameters) {}
	size_t Put2(const byte *begin, size_t length, int messageEnd, bool blocking)
		{return 0;}
};
