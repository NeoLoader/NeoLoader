...
public:
	...
	static void CRYPTOPP_API StaticAlgorithmName(char* Name) {strcat(Name, "CFB");}
...
public:
	...
	static void CRYPTOPP_API StaticAlgorithmName(char* Name) {strcat(Name, "OFB");}
...
public:
	...
	static void CRYPTOPP_API StaticAlgorithmName(char* Name) {strcat(Name, "CTR");}
...
public:
	...
	static void CRYPTOPP_API StaticAlgorithmName(char* Name) {strcat(Name, "ECB");}
};
...
public:
	...
	static void CRYPTOPP_API StaticAlgorithmName(char* Name) {strcat(Name, "CBC");}
};
...
public:
	...
	static void CRYPTOPP_API StaticAlgorithmName(char* Name) {strcat(Name, "CBC/CTS");}
...
public:
	...
	static void CRYPTOPP_API StaticAlgorithmName(char* Name)
	{
		CIPHER::StaticAlgorithmName(Name);
		strcat(Name, "/");
		BASE::StaticAlgorithmName(Name);
	}
};
...
public:
	...
	void AlgorithmName(char* Name) const
	{
		if(this->m_cipher)
		{
			this->m_cipher->AlgorithmName(Name);
			strcat(Name, "/");
		}
		BASE::StaticAlgorithmName(Name);
	}
