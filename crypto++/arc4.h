...
//! _
class CRYPTOPP_DLL CRYPTOPP_NO_VTABLE ARC4_Base : public VariableKeyLength<16, 1, 256>, public RandomNumberGenerator, public SymmetricCipher, public SymmetricCipherDocumentation
{
public:
	~ARC4_Base();

	//static const char *StaticAlgorithmName() {return "ARC4";}
	static void StaticAlgorithmName(char* Name) {strcat(Name, "ARC4");}
...
{
public:
	//static const char CRYPTOPP_DLL *StaticAlgorithmName() {return "MARC4";}
	static void CRYPTOPP_DLL StaticAlgorithmName(char* Name) {strcat(Name, "MARC4");}
