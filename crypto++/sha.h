...
public:
	...
	static void CRYPTOPP_API StaticAlgorithmName(char* Name) {strcat(Name, "SHA-1");}
};
...
public:
	...
	static void CRYPTOPP_API StaticAlgorithmName(char* Name) {strcat(Name, "SHA-256");}
};
...
public:
	...
	static void CRYPTOPP_API StaticAlgorithmName(char* Name) {strcat(Name, "SHA-224");}
};
...
public:
	...
	static void CRYPTOPP_API StaticAlgorithmName(char* Name) {strcat(Name, "SHA-512");}
};
...
public:
	...
	static void CRYPTOPP_API StaticAlgorithmName(char* Name) {strcat(Name, "SHA-384");}
};
