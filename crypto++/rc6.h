...
{
	//CRYPTOPP_DLL static const char *StaticAlgorithmName() {return "RC6";}
	CRYPTOPP_DLL static void StaticAlgorithmName(char* Name) {strcat(Name, "RC6");}
	typedef word32 RC6_WORD;
};

/// <a href="http://www.weidai.com/scan-mirror/cs.html#RC6">RC6</a>
class CRYPTOPP_DLL RC6 : public RC6_Info, public BlockCipherDocumentation
{
	class CRYPTOPP_DLL CRYPTOPP_NO_VTABLE Base : public BlockCipherImpl<RC6_Info>
	{
	public:
