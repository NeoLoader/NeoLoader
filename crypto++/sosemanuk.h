...
{
	//static const char CRYPTOPP_DLL * StaticAlgorithmName() {return "Sosemanuk";}
	static void CRYPTOPP_API StaticAlgorithmName(char* Name) {strcat(Name, "Sosemanuk");}
};

//! _
class CRYPTOPP_DLL SosemanukPolicy : public AdditiveCipherConcretePolicy<word32, 20>, public SosemanukInfo
{
protected:
