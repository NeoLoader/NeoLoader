...
public:
	...
	static void StaticAlgorithmName(char* Name) {strcat(Name, "RIPEMD-160");}
};
...
public:
	...
	static void StaticAlgorithmName(char* Name) {strcat(Name, "RIPEMD-320");}
};
...
public:
	...
	static void StaticAlgorithmName(char* Name) {strcat(Name, "RIPEMD-128");}
};
...
public:
	...
	static void StaticAlgorithmName(char* Name) {strcat(Name, "RIPEMD-256");}
};
