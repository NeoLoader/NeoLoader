...
public:
	...
	void AlgorithmName(char* Name) const {m_cipher.AlgorithmName(Name);}
...
public:
	...
	void AlgorithmName(char* Name) const {m_hashModule.AlgorithmName(Name);}
	void IsolatedInitialize(const NameValuePairs &parameters);
	size_t Put2(const byte *begin, size_t length, int messageEnd, bool blocking);
...
public:
	...
	void AlgorithmName(char* Name) const {m_hashVerifier.AlgorithmName(Name);}
	byte * ChannelCreatePutSpace(const std::string &channel, size_t &size);
	size_t ChannelPut2(const std::string &channel, const byte *begin, size_t length, int messageEnd, bool blocking);
...
public:
	...
	void AlgorithmName(char* Name) const {m_signer.AlgorithmName(Name);}
...
public:
	...
	void AlgorithmName(char* Name) const {m_verifier.AlgorithmName(Name);}
