...
public:
	...
	static void CRYPTOPP_API StaticAlgorithmNamePrefix(char* Name) {strcat(Name, "");}
...
public:
	...
	static void CRYPTOPP_API StaticAlgorithmName(char* Name) {strcat(Name, "DSA-1363");}
...
public:
	...
	static void CRYPTOPP_API StaticAlgorithmName(char* Name) {strcat(Name, "NR");}
	...
	DSA>
{
	...
	static void CRYPTOPP_API StaticAlgorithmName(char* Name) {strcat(Name, "DSA");}
		...
		DLIES<> >
{
	...
	static void CRYPTOPP_API StaticAlgorithmName(char* Name) {strcat(Name, "DLIES");}
};
