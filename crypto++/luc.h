...
*/
class CRYPTOPP_DLL LUCFunction : public TrapdoorFunction, public PublicKey
{
...
//! _
class CRYPTOPP_DLL InvertibleLUCFunction : public LUCFunction, public TrapdoorFunctionInverse, public PrivateKey
{
...
struct LUC
{
	//static std::string CRYPTOPP_DLL StaticAlgorithmName() {return "LUC";}
	static void StaticAlgorithmName(char* Name) {strcat(Name, "LUC");}
...
class CRYPTOPP_DLL DL_GroupPrecomputation_LUC : public DL_GroupPrecomputation<Integer>
{
public:
...
//! _
class CRYPTOPP_DLL DL_BasePrecomputation_LUC : public DL_FixedBasePrecomputation<Integer>
{
public:
...
//! _
class CRYPTOPP_DLL DL_GroupParameters_LUC : public DL_GroupParameters_IntegerBasedImpl<DL_GroupPrecomputation_LUC, DL_BasePrecomputation_LUC>
{
public:
	// DL_GroupParameters
...
//! _
class CRYPTOPP_DLL DL_GroupParameters_LUC_DefaultSafePrime : public DL_GroupParameters_LUC
{
public:
...
//! _
class CRYPTOPP_DLL DL_Algorithm_LUC_HMP : public DL_ElgamalLikeSignatureAlgorithm<Integer>
{
public:
	//static const char * StaticAlgorithmName() {return "LUC-HMP";}
	static void StaticAlgorithmName(char* Name) {strcat(Name, "LUC-HMP");}
