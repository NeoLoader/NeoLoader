...
class CRYPTOPP_DLL GFP2Element
{
public:
	GFP2Element() {}
...
void CRYPTOPP_DLL XTR_FindPrimesAndGenerator(RandomNumberGenerator &rng, Integer &p, Integer &q, GFP2Element &g, unsigned int pbits, unsigned int qbits);

GFP2Element CRYPTOPP_DLL XTR_Exponentiate(const GFP2Element &b, const Integer &e, const Integer &p);
