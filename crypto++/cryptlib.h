...
public:
	...
	virtual void AlgorithmName(char* Name) const {strcat(Name, "unknown");}
};
...
public:
	...
	virtual unsigned int IVSize() const {char Name[128] = ""; GetAlgorithm().AlgorithmName(Name); throw NotImplemented(std::string(Name) + ": this object doesn't support resynchronization");}
	...
	virtual void Resynchronize(const byte *iv, int ivLength=-1) {char Name[128] = ""; GetAlgorithm().AlgorithmName(Name); throw NotImplemented(std::string(Name) + ": this object doesn't support resynchronization");}
...
public:
	...
	virtual void AlgorithmName(char* Name) const =0;
