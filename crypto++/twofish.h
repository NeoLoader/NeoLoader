...
{
	//CRYPTOPP_DLL static const char *StaticAlgorithmName() {return "Twofish";}
	CRYPTOPP_DLL static void StaticAlgorithmName(char* Name) {strcat(Name, "Twofish");}
};

/// <a href="http://www.weidai.com/scan-mirror/cs.html#Twofish">Twofish</a>
class CRYPTOPP_DLL Twofish : public Twofish_Info, public BlockCipherDocumentation
{
	class CRYPTOPP_DLL CRYPTOPP_NO_VTABLE Base : public BlockCipherImpl<Twofish_Info>
	{
	public:
