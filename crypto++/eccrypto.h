...
public:
	...
	static void CRYPTOPP_API StaticAlgorithmNamePrefix(char* Name) {strcat(Name, "EC");}
...
public:
	...
	static void StaticAlgorithmName(char* Name) {strcat(Name, "ECDSA");}
};
...
public:
	...
	static void StaticAlgorithmName(char* Name) {strcat(Name, "ECNR");}
};
		...
		ECIES<EC> >
{
	...
	static void StaticAlgorithmName(char* Name) {strcat(Name, "ECIES");}
};
