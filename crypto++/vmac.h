...
public:
	...
	void AlgorithmName(char* Name) const {strcat(Name, "VMAC("); GetCipher().AlgorithmName(Name); strcat(Name, ")-"); strcat(Name, IntToString(DigestSize()*8).c_str());}
...
public:
	...
	static void StaticAlgorithmName(char* Name) {strcat(Name, "VMAC("); T_BlockCipher::StaticAlgorithmName(Name); strcat(Name, ")-"); strcat(Name, IntToString(T_DigestBitSize).c_str());}
