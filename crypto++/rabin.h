...
//! _
class CRYPTOPP_DLL RabinFunction : public TrapdoorFunction, public PublicKey
{
...
//! _
class CRYPTOPP_DLL InvertibleRabinFunction : public RabinFunction, public TrapdoorFunctionInverse, public PrivateKey
{
...
struct Rabin
{
	//static std::string CRYPTOPP_DLL StaticAlgorithmName() {return "Rabin-Crypto++Variant";}
	static void CRYPTOPP_DLL StaticAlgorithmName(char* Name) {strcat(Name, "Rabin-Crypto++Variant");}
