...
#include "../MT/ThreadLock.h"
#include "Archive.h"

class CArchiveWorker: public QObjectEx
{
	Q_OBJECT
...
class NEOHELPER_EXPORT CArchiveThread: public QThreadEx
{
	Q_OBJECT

public:
	CArchiveThread(const QString &ArchivePath, const QString &WorkingPath, const QString &Password, quint64 PartSize = -1, const QStringList& Parts = QStringList());
	CArchiveThread(const QString &WinRarPath, const QString &ArchivePath, const QString &WorkingPath, const QString &Password, quint64 PartSize = -1, const QString &CommentPath = "");
	void Terminate();
...
class C7zWorker: public CArchiveWorker, protected CArchive 
{
	Q_OBJECT

public:
	C7zWorker(const QString &ArchivePath, const QString &WorkingPath, const QString &Password, quint64 PartSize = -1, const QStringList& Parts = QStringList());
	~C7zWorker();
...
class CRarWorker: public CArchiveWorker
{
	Q_OBJECT

public:
	CRarWorker(const QString &WinRarPath, const QString &ArchivePath, const QString &WorkingPath, const QString &Password, quint64 PartSize = -1, const QString &CommentPath = "");
