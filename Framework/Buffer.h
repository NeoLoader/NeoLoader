...
class NEOHELPER_EXPORT CBuffer
{
public:
	CBuffer()													{Init();}
	...
	void			WriteString(const wstring& String, EStrSet Set = eUtf8, EStrLen Len = e16Bit);
	wstring			ReadString(EStrSet Set = eUtf8, EStrLen Len = e16Bit) const;
	wstring			ReadString(EStrSet Set, size_t uRawLength) const;
...
void NEOHELPER_EXPORT WStrToAscii(string& dest, const wstring& src);
void NEOHELPER_EXPORT WStrToUtf8(string& dest, const wstring& src);
void NEOHELPER_EXPORT AsciiToWStr(wstring& dest, const string& src);
void NEOHELPER_EXPORT Utf8ToWStr(wstring& dest, const string& src);
