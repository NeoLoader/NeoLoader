...
public:
	...
	static QScriptValue toScriptValue(const QScriptDebuggerValue& value, QScriptEngine *engine);
	static QScriptDebuggerValue toDebuggerValue(const QScriptValue &value);
