    ...
    : QScriptDebuggerCodeViewInterface(*new QScriptDebuggerCodeViewPrivate, parent, 0)
{
	...
	//> NeoScriptTools
	QObject::connect(d->editor, SIGNAL(modificationChanged(bool)),
...
QString QScriptDebuggerCodeView::name() const
{
	Q_D(const QScriptDebuggerCodeView);
    return d->name;
}

void QScriptDebuggerCodeView::setName(const QString &name)
{
	Q_D(QScriptDebuggerCodeView);
    d->name = name;
}
...
//> NeoScriptTools
void QScriptDebuggerCodeView::setReadOnly(bool set)
{
    Q_D(QScriptDebuggerCodeView);
    d->editor->setReadOnly(set);
}

void QScriptDebuggerCodeView::setModified(bool set)
{
    Q_D(QScriptDebuggerCodeView);
    d->editor->document()->setModified(set);
}
//< NeoScriptTools
