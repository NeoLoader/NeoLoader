...
public:
    ...
    void setScriptsModel(QScriptDebuggerScriptsModel *model, 
                                ...
                                QScriptDebuggerCommandSchedulerInterface *commandScheduler = NULL);
	...
	QScriptDebuggerCodeViewInterface* setCurrentScript(qint64 scriptId, const QScriptScriptData& data);
	void setCurrentScript(const QString& fileName);
    ...
    void setCurrentCustom(qint64 customID, const QString& name, QScriptDebuggerCustomViewInterfaceFactory factory, void* param);

	QScriptDebuggerCustomViewInterface *currentCustom() const;

	QString currentName() const;

	void renameCurrent(QScriptDebuggerCodeViewInterface* view, const QString& name);
...
private:
	...
	//> NeoScriptTools
	Q_PRIVATE_SLOT(d_func(), void _q_onModificationChanged(bool))
	//< NeoScriptTools
};

#include "qscriptdebuggercodewidget_p_p.h"
